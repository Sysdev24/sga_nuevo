...
@section('title', 'Reporte Tramites')

@section('content_header')
    <center><b> <h1 class="m-0 text-dark">Reportes Auditoria Tramites</h1> </b></center>
@stop
                ...
                <div class="col-12" >
                    ...
                    <!-- <form action="{{-- url('reportes_extranjeros_pdf') --}}" method="get" role="form" id="form">
                        ...
                        <input type="hidden" name="estatus_usuario_search" id="estatus_usuario_search" value="{{-- $estatus_usuario_search --}}" /> -->
                         ...
                         <div class="row" style="btn btn-primary btn-sm">
                            <a href="{{ route ('reporteauditoriatramite.excel') }}" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>   Reporte Excel</a>
                        </div>
...
/* $(document).ready( function () {
            ...
            $("#dataTable").DataTable({
                ...
                "language": {
                    ...
                    "search": "Buscar",
          me estoy enamorando function cargarOficinas(tipo_oficina) {
            $.ajax({
                method: "POST",
